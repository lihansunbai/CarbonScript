...
%% 建立文件列表
for i = [2010:2018]
    filelist{i-2010+1} =['D:\\workplace\\geodatabase\\raster\\total_emission_'  num2str(i) '.TIFF'];
end
...
for i = [1:length(filelist)]
    ...
    temp_rawdata = log10(temp_rawdata);
...
%% 输出文件名
tiffile = 'test_emission_log_variance_10.tif' ;
geotiffwrite(tiffile,flip(emission_variance,1),temp_georefference)
%% Read geotiff file
